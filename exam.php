...
// If authenticated, proceed with exam logic
require_once 'fetch_data.php';

// Static student data as per your request
$student = [
    'full_name' => 'JOHN SMITH',
    'is_blind' => false,
    'is_deaf' => false,
    'exam_center' => 'ADDIS ABABA',
    'school' => 'TULDIM(R)',
    'admission_number' => '921231410',
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', sans-serif; }
        ...
        #student-confirm-modal { display: flex; }
...
<body>
    <div class="container">
        ...
        <div class="main-content">
            <div class="header" id="student-info-header" style="display: none;">
    ...
    <div class="modal" id="student-confirm-modal">
        <div class="modal-content">
            <h2>Confirm Your Details</h2>
            <p>Please confirm the following student information:</p>
            <ul>
                <li><strong>FULL NAME:</strong> JOHN SMITH</li>
                <li><strong>Is Blind / Is Deaf:</strong> No / No</li>
                <li><strong>EXAM CENTER:</strong> ADDIS ABABA</li>
                <li><strong>School:</strong> TULDIM(R)</li>
                <li><strong>ADMISSION NUMBER:</strong> 921231410</li>
                <li><strong>ENROLLMENT TYPE:</strong> Regular</li>
            </ul>
            <button class="start-btn" id="confirm-student-btn">Confirm</button>
        </div>
    </div>
    ...
    <script>
        ...
        const studentConfirmModal = document.getElementById('student-confirm-modal');
        ...
        // Show student confirmation modal on page load (no input fields)
        studentConfirmModal.style.display = 'flex';
        questionContainer.style.display = 'none';
        prevButton.style.display = 'none';
        nextButton.style.display = 'none';

        confirmStudentBtn.addEventListener('click', () => {
            studentConfirmModal.style.display = 'none';
            studentInfoHeader.style.display = 'flex';
            questionContainer.style.display = 'block';
            prevButton.style.display = 'block';
            nextButton.style.display = 'block';
            fetchYears(subjectSelect.value); // Start fetching exam data after confirmation
        });
